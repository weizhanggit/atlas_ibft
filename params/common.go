...
var (
	...
	RegistrySmartContractAddress = common.HexToAddress("0x000000000000000000000000000000000000ce10") //api 方法
	//制作RegistryId makeRegistryId 合约地址是可以初始化的时候赋值的
	//AttestationsRegistryId         = makeRegistryId("Attestations")
	BlockchainParametersRegistryId = makeRegistryId("BlockchainParameters") //0x8b91d837e1684f7353d73b6197230894243cf869282f722841df96b441303f37
